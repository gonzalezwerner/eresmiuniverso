...
function _0x6b42() {
    const _0x41745e = ['classList', 'paused', 'isPlaying', '12phpwXf', '1293333FUxZXO', 'warn', 'getElementById', '1299816JrrRep', '1qiPhzK', '8IhSUti', 'loop', '3289cAxiLY', 'toggle-audio', 'auto', 'preload', 'audio', 'DOMContentLoaded', '1863896GXvljK', 'remove', 'updateUI', 'add', 'click', 'https://github.com/gonzalezwerner/eresmiuniverso/raw/refs/heads/main/TU%20POETA%20Alex%20Campos%20V%C3%ADdeo%20oficial%20(mp3cut.net).mp3', 'catch', 'playsinline', 'play', 'init', 'fa-volume-xmark', 'addEventListener', 'Lỗi\x20phát\x20nhạc:', '6323310DRwZRz', 'volume', 'fa-volume-high', '352856XfSyzD', '29570zncATQ', 'togglePlayback', '337840QlFHUM', 'pause'];
    _0x6b42 = function() {
        return _0x41745e;
    }
    ;
...
const heartImages = [
  'https://i.imgur.com/Wpvzbaa.jpeg',
  'https://i.imgur.com/DkY2OQB.jpeg',
  'https://i.imgur.com/HHyyceR.jpeg'
]
